...
describe('Change Hierarchy Test', () => {
  ...
  it('Should call  notification', () => {
    ...
    saga.next().put({ type: actionTypes.NOTIFICATION, title: 'This Action Is Not Possible, You Are Making a Loop!', style: 'error' })
      .next().isDone();
  });
});
...
describe('Remove Person Test', () => {
  ...
  it('Should remove a person', () => {
    ...
    saga.next().put({ type: actionTypes.REMOVE_PERSON, personId: action.personId })
